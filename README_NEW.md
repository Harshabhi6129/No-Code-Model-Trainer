...
- **FastAPI** - Single file, 200 lines
- **Minimal endpoints** - Upload, analyze, train, export
- **WebSocket streaming** - Real-time training updates
- **No complexity** - Just the essentials

**Frontend** (`nlp-finetune-ui/src/`):
- **React + TypeScript** - Modern and type-safe
- **5 Components** - One per workflow step
